...
if __name__ == '__main__':
    ...
    # Didactic notes: Easy enough!

    # Also, for next time, I recommend including some discussion in the
    # solution. Maybe how good the compression is, or how fast?

    # It also helps my testing purposes if we all stick to the English names of functions. This way I can paste
    # tests more easily, if I want to run them.